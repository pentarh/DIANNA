...
public class MainTest {
	...
	/**
	 * Testing key PRIV:
	 * 155c572331fe3de390ff0bf82f1dc340d4fd621fe15e0fa4b8b84b046bc3608f PUB: 04
	 * b59a5e7b00699d1e0a546364d54fe3863d32378775c28335ba2c9a8cbdbe2e90f1ffa61564254930e6d2f5be5a0e666b40ee09323d61df429002dc19d91309c5
	 */
	/**
	 * @param args
	...
	@Test
	@Ignore
	// TODO we should rework this test with asserts
	public void testKey() {
		// Create transaction
		byte[] priv = Hex
				.decode("155c572331fe3de390ff0bf82f1dc340d4fd621fe15e0fa4b8b84b046bc3608f");
		byte[] pub = Hex
		...
		byte[] value = "@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;@ IN NS ns1.hosting.com.;"
				.getBytes();
		// Just fake fee trans
